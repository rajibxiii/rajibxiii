...
**Web & Backend**
`HTML/CSS` `MySQL` `Firebase` `PHP`

**Tools**
`Git` `Figma` `LaTeX` `Photoshop` `Canva`
...
|---|---|
| [face-attend](https://github.com/rajibxiii/face-attend) | Face recognition attendance system — because signing sheets is a waste of everyone's time |
| [coffee-machine](https://github.com/rajibxiii/coffee-machine) | Simulated coffee machine in Python |
| [blackjack-game](https://github.com/rajibxiii/blackjack-game) | Blackjack, terminal-style |
| [blind-auction](https://github.com/rajibxiii/blind-auction) | Blind auction program |
